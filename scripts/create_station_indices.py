...
def main():
	# 1. Load obs file
	obs_path = paths.ARCHIVE_RAW_DATA_DIR / 'raw_data_20260217.json'
	...
	# 3. Load HRRR grid
	lat_grid = np.load(paths.TRAINING_DATA_DIR / 'lat_grid.npy')
	lon_grid = np.load(paths.TRAINING_DATA_DIR / 'lon_grid.npy')
