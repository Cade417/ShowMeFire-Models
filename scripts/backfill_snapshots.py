...
ARCHIVE_FORECASTS = paths.ARCHIVE_FORECASTS_DIR
ARCHIVE_RAW = paths.ARCHIVE_RAW_DATA_DIR
SNAPSHOT_BASE = paths.SNAPSHOTS_DIR
...
def run_backfill():
    ...
    conn.commit()
    conn.close()
    print(f"Done! Check {SNAPSHOT_BASE} and {DB_PATH}.")
