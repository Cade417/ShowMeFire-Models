...
# This repo's own independent registry, anchored under SMF_DATA_ROOT (not
# the server's api/models/ - the two registries are never shared directly).
MODELS_DIR = paths.MODELS_DIR
API_DIR = paths.DATA_ROOT
