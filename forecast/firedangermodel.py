...
def load_hrrr_archived_data(hrrr_dir: str = str(paths.CACHE_HRRR_DIR)) -> pd.DataFrame:
...
def load_all_archived_data(archive_dir: str = str(paths.ARCHIVE_RAW_DATA_DIR), 
                          hrrr_dir: str = str(paths.CACHE_HRRR_DIR),
...
def train_and_save_fire_danger_model(archive_dir: str = str(paths.ARCHIVE_RAW_DATA_DIR),
                                     hrrr_dir: str = str(paths.CACHE_HRRR_DIR),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hrrr-dir', default=str(paths.CACHE_HRRR_DIR), help='HRRR archive directory')
