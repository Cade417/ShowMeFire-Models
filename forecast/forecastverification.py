...
def load_all_archived_data(archive_dir: str = str(paths.ARCHIVE_RAW_DATA_DIR)) -> pd.DataFrame:
    """
...
def load_forecast_data(model_run: str, forecast_dir: str = str(paths.ARCHIVE_FORECASTS_DIR)) -> Dict:
...
def run_forecast_verification(model_run: str = None, 
                              forecast_dir: str = str(paths.ARCHIVE_FORECASTS_DIR),
                              archive_dir: str = str(paths.ARCHIVE_RAW_DATA_DIR)):
    """
...
def run_daily_training(archive_dir: str = str(paths.ARCHIVE_RAW_DATA_DIR), 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--archive-dir', default=str(paths.ARCHIVE_RAW_DATA_DIR), help='Archive directory')
    parser.add_argument('--model-dir', default=str(paths.MODELS_DIR), help='Model save directory')
    parser.add_argument('--forecast-dir', default=str(paths.ARCHIVE_FORECASTS_DIR), help='Forecast archive directory')
